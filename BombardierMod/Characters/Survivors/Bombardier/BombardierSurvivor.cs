...
{
    public class BombardierSurvivor : SurvivorBase<BombardierSurvivor>
    {
        public override string assetBundleName => "bombardierassetbundle";

        public override string bodyName => "BombardierBody";

        public override string masterName => "BombardierMonsterMaster";

        public override string modelPrefabName => "mdlBombardier";
        public override string displayPrefabName => "BombardierDisplay";

        public const string Bombardier_PREFIX = BombardierPlugin.DEVELOPER_PREFIX + "_BOMBARDIER_";

        //used when registering your survivor's language tokens
        public override string survivorTokenPrefix => Bombardier_PREFIX;
        
        public override BodyInfo bodyInfo => new BodyInfo
        {
            bodyName = bodyName,
            bodyNameToken = Bombardier_PREFIX + "NAME",
            subtitleNameToken = Bombardier_PREFIX + "SUBTITLE",

            characterPortrait = assetBundle.LoadAsset<Texture>("texBombardierIcon"),
        ...
        public override CustomRendererInfo[] customRendererInfos => new CustomRendererInfo[]
        {
                new CustomRendererInfo
                {
                    ...
                    material = assetBundle.LoadMaterial("matBombardier"),
                },
                new CustomRendererInfo
                {
                    childName = "GunModel",
        ...
        public override UnlockableDef characterUnlockableDef => BombardierUnlockables.characterUnlockableDef;
        
        public override ItemDisplaysBase itemDisplays => new BombardierItemDisplays();
        ...
        public override void Initialize()
        {
            ...
            //ConfigEntry<bool> characterEnabled = Config.CharacterEnableConfig("Survivors", "Bombardier");
        ...
        public override void InitializeCharacter()
        {
            ...
            BombardierUnlockables.Init();

            base.InitializeCharacter();

            BombardierConfig.Init();
            BombardierStates.Init();
            BombardierTokens.Init();
        ...
        {
            AddHitboxes();
            bodyPrefab.AddComponent<BombardierWeaponComponent>();
        ...
        public override void InitializeEntityStateMachines() 
        {
            ...
            //if you set up a custom main characterstate, set it up here
                //don't forget to register custom entitystates in your BombardierStates.cs
        ...
        public override void InitializeSkins()
        {
            ...
            //SkinDef masterySkin = Modules.Skins.CreateSkinDef(Bombardier_PREFIX + "MASTERY_SKIN_NAME",
            //    assetBundle.LoadAsset<Sprite>("texMasteryAchievement"),
            //    defaultRendererinfos,
            //    prefabCharacterModel.gameObject,
            //    BombardierUnlockables.masterySkinUnlockableDef);

            ////adding the mesh replacements as above. 
            ////if you don't want to replace the mesh (for example, you only want to replace the material), pass in null so the order is preserved
            //masterySkin.meshReplacements = Modules.Skins.getMeshReplacements(assetBundle, defaultRendererinfos,
            //    "meshBombardierSwordAlt",
            //    null,//no gun mesh replacement. use same gun mesh
            //    "meshBombardierAlt");

            ////masterySkin has a new set of RendererInfos (based on default rendererinfos)
            ////you can simply access the RendererInfos' materials and set them to the new materials for your skin.
            //masterySkin.rendererInfos[0].defaultMaterial = assetBundle.LoadMaterial("matBombardierAlt");
            //masterySkin.rendererInfos[1].defaultMaterial = assetBundle.LoadMaterial("matBombardierAlt");
            //masterySkin.rendererInfos[2].defaultMaterial = assetBundle.LoadMaterial("matBombardierAlt");
        ...
        public override void InitializeCharacterMaster()
        {
            ...
            BombardierAI.Init(bodyPrefab, masterName);
        ...
        private void RecalculateStatsAPI_GetStatCoefficients(CharacterBody sender, R2API.RecalculateStatsAPI.StatHookEventArgs args)
        {
            ...
            if (sender.HasBuff(BombardierBuffs.armorBuff))
            {
                args.armorAdd += 300;
            }
        }
